...
@dag(dag_id="users_datamart",
     schedule_interval=None,
     start_date=datetime(2021, 1, 1),
     catchup=False,
     tags=["sprint7_project", "users_datamart"],
...
def users_datamart():
    ...
    t_submit = SparkSubmitOperator(
                   task_id="users_datamart",
                   application ="/lessons/scripts/users_datamart_job.py",
                   conn_id= "yarn_spark",
                   application_args = ["2022-05-31",
                                       ...
                                       "/user/sppetrov12/data/analytics/users_datamart"
                                      ],
...
users_datamart_dag = users_datamart()
